  ...
  var hoistFnE = function (dictMonad) {
      return function (f) {
          return Validation(function (form) {
              return function ($52) {
                  return Control_Applicative.pure(dictMonad.Applicative0())(f(form)($52));
              };
          });
      };
  };
...
(function(exports) {
  ...
  var genericValidStatus = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Formless.Types.Component line 97, column 8 - line 97, column 60: " + [ x.constructor.name ]);
  }, function (x) {
...
(function(exports) {
  ...
  var validate_ = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return new Formless_Types_Component.Validate(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Formless_Types_Form.U.value)), Data_Unit.unit);
              };
          };
      };
  };                                                                
  var submitReply = Halogen_Query.request(Formless_Types_Component.SubmitReply.create);
  var submit = Formless_Types_Component.Submit.create;
  ...
  var send$prime = function (path) {
      return function (p) {
          return function (q) {
              return new Formless_Types_Component.Send(Halogen_Component_ChildPath.injSlot(path)(p), Halogen_Component_ChildPath.injQuery(path)(q));
          };
      };
  };
  var send = function (p) {
      return function (q) {
          return new Formless_Types_Component.Send(p, q);
      };
  };
  ...
  var resetAll_ = new Formless_Types_Component.ResetAll(Data_Unit.unit);                 
  var raise = Formless_Types_Component.Raise.create;
  var modify = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (f) {
                      return Formless_Types_Component.Modify.create(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(f))));
                  };
              };
          };
      };
  };
  var initialize_ = Data_Function.flip(Formless_Types_Component.Initialize.create)(Data_Unit.unit);
  exports["send"] = send;
          ...
          return function (dictCons) {
              return function (sym) {
                  return function (dictWander) {
                      return function ($87) {
                          return _Result(dictIsSymbol)(dictNewtype)(dictCons)(sym)(dictWander.Strong0())(Data_Lens_Prism_Maybe._Just(dictWander.Choice1())(Data_Lens_Prism_Either._Left(dictWander.Choice1())($87)));
                      };
                  };
              };
          };
                          ...
                          return function (fieldType) {
                              return function (config) {
                                  return function (state) {
                                      var props = [ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(dictIsSymbol)(dictNewtype)(dictCons)(config.sym)(state.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(dictIsSymbol)(dictNewtype1)(dictCons1)(config.sym))) ];
                                      ...
                                      })(Data_Lens_Fold.preview(Formless_Retrieve._Error(dictIsSymbol)(dictNewtype)(dictCons)(config.sym)(Data_Lens_Internal_Forget.wanderForget(Data_Maybe_First.monoidFirst)))(state.form));
...
(function(exports) {
  ...
  var GetItems = (function () {
      function GetItems(value0) {
          this.value0 = value0;
      };
      GetItems.create = function (value0) {
          return new GetItems(value0);
      };
      return GetItems;
  })();
  var Remove = (function () {
                                      ...
                                      var $$eval = function (v) {
                                          if (v instanceof Clear) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                                  ...
                                                  $33.selected = Data_Monoid.mempty(dictMonoid);
                                                  return $33;
                                              }))(function (v1) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.replaceItems(v1.items)))(function (v2) {
                                          ...
                                          if (v instanceof Remove) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                  ...
                                                  $38.selected = remove$prime(v.value0)(st.selected);
                                                  return $38;
                                              }))(function (v1) {
                                          ...
                                          if (v instanceof GetItems) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(v1.items));
                                              });
                                          };
                                          if (v instanceof HandleSelect) {
                                              ...
                                              if (v.value0 instanceof Select.Searched) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                      var items = Data_Array.filter(function ($66) {
                                                          return Data_String_CodeUnits.contains(v.value0.value0)(Example_App_Validation.toText(dictToText)($66));
                                                      })(v1.items);
                                              ...
                                              if (v.value0 instanceof Select.Selected) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                      ...
                                                      $50.selected = select$prime(v.value0.value0)(st.selected);
                                                      return $50;
                                                  }))(function (v1) {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.setVisibility(Select.Off.value)))(function (v2) {
                                          ...
                                          throw new Error("Failed pattern match at Example.App.UI.Typeahead line 152, column 10 - line 184, column 17: " + [ v.constructor.name ]);
                                      };
                                      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
                                          initialState: initialState,
                                          render: render,
  ...
  var multi = function (dictMonadAff) {
      return function (dictToText) {
          return function (dictEq) {
              var render = function (st) {
                  return function (selectState) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ (function () {
                          ...
                          var $58 = Data_Eq.eq(Select.eqVisibility)(selectState.visibility)(Select.On.value);
                          if ($58) {
              ...
              return component$prime(dictMonadAff)(Data_Functor.functorArray)(Data_Monoid.monoidArray)(dictToText)(dictEq)(Data_Array.cons)(function ($67) {
                  return Data_Array.filter(Data_Eq.notEq(dictEq)($67));
              ...
              return function (dictSemigroup) {
                  var render = function (st) {
                      return function (selectState) {
                          if (st.selected instanceof Data_Maybe.Just) {
                              return Halogen_HTML_Elements.div([ (function () {
                                  var $60 = Data_Eq.eq(Select.eqVisibility)(selectState.visibility)(Select.On.value);
                                  if ($60) {
                                      return Example_App_UI_Element.css("dropdown is-active");
                                  };
                                  return Example_App_UI_Element.css("dropdown is-flex");
                          ...
                          if (st.selected instanceof Data_Maybe.Nothing) {
                              return Halogen_HTML_Elements.div([ (function () {
                                  var $62 = Data_Eq.eq(Select.eqVisibility)(selectState.visibility)(Select.On.value);
                                  if ($62) {
                                      return Example_App_UI_Element.css("dropdown is-flex is-active");
                                  };
                                  return Example_App_UI_Element.css("dropdown is-flex");
                          ...
                          throw new Error("Failed pattern match at Example.App.UI.Typeahead line 57, column 27 - line 75, column 8: " + [ st.selected.constructor.name ]);
                      };
                  };
                  var filter$prime = function (items) {
                      return function (v) {
                          ...
                          throw new Error("Failed pattern match at Example.App.UI.Typeahead line 54, column 3 - line 54, column 32: " + [ items.constructor.name, v.constructor.name ]);
                      };
                  };
                  return component$prime(dictMonadAff)(Data_Maybe.functorMaybe)(Data_Maybe.monoidMaybe(dictSemigroup))(dictToText)(dictEq)(function ($68) {
                      return Data_Function["const"](Data_Maybe.Just.create($68));
  ...
  var renderFormless = function (state) {
      return Example_App_UI_Element.formContent_([ Example_App_UI_Element.input({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Write your name")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(newtypeContactForm)()(Data_Symbol.SProxy.value)(state.form)),
          placeholder: "Dale"
      })([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(newtypeContactForm)()(Data_Symbol.SProxy.value)(state.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(newtypeContactForm)()(Data_Symbol.SProxy.value))) ]), Example_App_UI_Element.textarea({
          label: "Message",
          help: new Data_Either.Right("Write us a message"),
          placeholder: "We prefer nice messages, but have at it."
      })([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          return "text";
      }))(newtypeContactForm)()(Data_Symbol.SProxy.value)(state.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.set(new Data_Symbol.IsSymbol(function () {
          return "text";
      }))(newtypeContactForm)()(Data_Symbol.SProxy.value))) ]), Example_App_UI_Element.buttonPrimary([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.submit)) ])([ Halogen_HTML_Core.text("Submit") ]) ]);
  };
  var initialInputs = Formless_Transform_Record.wrapInputFields(newtypeContactForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
      return "name";
  ...
  var component = (function () {
      var render = function (st) {
          return Example_App_UI_Element.section_([ Example_App_UI_Element.h1_([ Halogen_HTML_Core.text("Formless") ]), Example_App_UI_Element.h2_([ Halogen_HTML_Core.text("A basic contact form.") ]), Example_App_UI_Element.p_("You can create a full Halogen contact form like this in less than 100 lines of code with " + ("Formless, most of which is simply Halogen boilerplate. The actual form spec and wiring " + "consists of less than 20 lines of code.")), Halogen_HTML_Elements.br_, Halogen_HTML.slot(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordVoid)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              ...
              return "text";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              return "text";
          }))()(Formless_Transform_Internal.inputFieldsToInputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              return "name";
              ...
              return "text";
          }))()(Formless_Transform_Internal.setFormFieldsTouchedNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              return "name";
              ...
              return "name";
          }))(Effect_Aff.monadAff)()(newtypeContactForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "text";
          }))(Effect_Aff.monadAff)()(newtypeContactForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationNil(Effect_Aff.monadAff))))(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "text";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(newtypeContactForm)(newtypeContactForm)(newtypeContactForm)(newtypeContactForm)(newtypeContactForm)(newtypeContactForm)(newtypeContactForm)(newtypeContactForm))({
      ...
      var $$eval = function (v) {
          if (v.value0 instanceof Formless_Types_Component.Submitted) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                  var contact = Formless_Transform_Record.unwrapOutputFields(newtypeContactForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      return "name";
                  ...
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.logShow(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "text";
                  }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showString)))(contact));
              })());
          };
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
      };
...
(function(exports) {
  ...
  var initialInputs = Formless_Transform_Row.mkInputFields()(newtypeUserForm$prime)(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "email";
      ...
      return "whiskey";
  }))(Formless_Class_Initial.initialMaybe)()(Formless_Transform_Row.mkInputFieldsFromRowNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Types_Form.FormProxy.value);
  exports["UserForm"] = UserForm;
  exports["prx"] = prx;
  exports["initialInputs"] = initialInputs;
  exports["validators"] = validators;
  exports["newtypeUserForm'"] = newtypeUserForm$prime;
...
(function(exports) {
  ...
  var whiskey = function (state) {
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Select a favorite whiskey")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "whiskey";
          }))(Example_ExternalComponents_Spec["newtypeUserForm'"])()((Example_ExternalComponents_Spec.prx()(Example_ExternalComponents_Spec["newtypeUserForm'"])(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).whiskey)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_ExternalComponents_Types.Typeahead.create(Example_ExternalComponents_Types.Whiskey.value)($2)));
      })) ]);
  };
  var language = function (state) {
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Choose your favorite programming language.")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).language)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_ExternalComponents_Types.Typeahead.create(Example_ExternalComponents_Types.Language.value)($3)));
      })) ]);
  };
  var email = function (state) {
      return Example_App_UI_Element.field({
          label: "Email",
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Choose an email address -- carefully.")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Example_ExternalComponents_Spec["newtypeUserForm'"])()((Example_ExternalComponents_Spec.prx()(Example_ExternalComponents_Spec["newtypeUserForm'"])(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).email)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_ExternalComponents_Types.Typeahead.create(Example_ExternalComponents_Types.Email.value)($4)));
      })) ]);
  };
  var formless = function (state) {
      return Example_App_UI_Element.formContent_([ Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(Example_App_Validation.toTextFieldError)(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])()()(Example_App_UI_Element.input)({
          label: "Name",
          help: "Write your name",
          placeholder: "Dale",
          sym: (Example_ExternalComponents_Spec.prx()(Example_ExternalComponents_Spec["newtypeUserForm'"])(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "language";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).name
          ...
          var $0 = state.submitting || Data_Eq.notEq(Formless_Types_Component.eqValidStatus)(state.validity)(Formless_Types_Component.Valid.value);
          if ($0) {
              return Halogen_HTML_Properties.disabled(true);
          };
          return Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.submit));
      })() ])([ Halogen_HTML_Core.text("Submit") ]), Example_App_UI_Element.button([ (function () {
          var $1 = !state.dirty;
          if ($1) {
              return Halogen_HTML_Properties.disabled(true);
          };
          return Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Types_Component.Raise.create(Halogen_Query.action(Example_ExternalComponents_Types.Reset.create))));
  ...
  var component = (function () {
      var render = function (st) {
          return Example_App_UI_Element.section_([ Example_App_UI_Element.h1_([ Halogen_HTML_Core.text("Formless") ]), Example_App_UI_Element.h2_([ Halogen_HTML_Core.text("A form leveraging external components and custom form actions.") ]), Example_App_UI_Element.p_("In Formless, you can freely leverage external components and embed them in the form. " + ("This form shows how to use custom typeahead components built with Select from " + ("CitizenNet. This form also demonstrates how you can manipulate forms in Formless. " + ("Try selecting an email address, then a whiskey. You'll notice that changing your " + "whiskey selection also clears the selected email.")))), Halogen_HTML_Elements.br_, Example_App_UI_Element.p_("Next, try opening the console. If you submit the form with invalid values, Formless will " + ("show you your errors. If you submit a valid form, you'll see Formless just returns the " + "valid outputs for you to work with.")), Halogen_HTML_Elements.br_, Halogen_HTML.slot(Data_Unit.unit)(Formless_Component.component(Example_ExternalComponents_Types.ordSlot)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              ...
              return "email";
          }))(Formless_Types_Form.eqInputField(Data_Maybe.eqMaybe(Data_Eq.eqString))))(Formless_Transform_Internal.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "language";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "email";
          }))(Effect_Aff.monadAff)()(Example_ExternalComponents_Spec["newtypeUserForm'"])()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "language";
          }))(Effect_Aff.monadAff)()(Example_ExternalComponents_Spec["newtypeUserForm'"])()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(Effect_Aff.monadAff)()(Example_ExternalComponents_Spec["newtypeUserForm'"])()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "whiskey";
          }))(Effect_Aff.monadAff)()(Example_ExternalComponents_Spec["newtypeUserForm'"])()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationNil(Effect_Aff.monadAff))))))(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "language";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"])(Example_ExternalComponents_Spec["newtypeUserForm'"]))({
              initialInputs: Example_ExternalComponents_Spec.initialInputs,
      ...
      var $$eval = function (v) {
          if (v instanceof Example_ExternalComponents_Types.Formless) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                  if (v.value0 instanceof Formless_Types_Component.Emit) {
                      return $$eval(v.value0.value0);
                  };
                  if (v.value0 instanceof Formless_Types_Component.Submitted) {
                      var user = Formless_Transform_Record.unwrapOutputFields(Example_ExternalComponents_Spec["newtypeUserForm'"])(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "email";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "language";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.logShow(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "whiskey";
                      }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showString))(Data_Show.showString))(Example_App_Validation.showEmail)))(user));
                  };
                  if (v.value0 instanceof Formless_Types_Component.Changed) {
                  ...
                  throw new Error("Failed pattern match at Example.ExternalComponents.Component line 52, column 26 - line 59, column 84: " + [ v.value0.constructor.name ]);
              })());
          };
          if (v instanceof Example_ExternalComponents_Types.Reset) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.send(Example_ExternalComponents_Types.Email.value)(Halogen_Query.request(Example_App_UI_Typeahead.GetItems.create))))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.logShow(Data_Show.showArray(Data_Show.showString))(Data_Maybe.fromMaybe([  ])(v1))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.send(Example_ExternalComponents_Types.Email.value)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create))))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.send(Example_ExternalComponents_Types.Whiskey.value)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create))))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.send(Example_ExternalComponents_Types.Language.value)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create))))(function (v4) {
                                  return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.resetAll_);
                              });
                          });
                      });
                  });
          ...
          if (v instanceof Example_ExternalComponents_Types.Typeahead) {
              if (v.value0 instanceof Example_ExternalComponents_Types.Email) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(Example_ExternalComponents_Spec["newtypeUserForm'"])()((Example_ExternalComponents_Spec.prx()(Example_ExternalComponents_Spec["newtypeUserForm'"])(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "whiskey";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).email)(v.value1.value0)));
              };
              if (v.value0 instanceof Example_ExternalComponents_Types.Whiskey) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                      return "whiskey";
                  }))(Example_ExternalComponents_Spec["newtypeUserForm'"])()((Example_ExternalComponents_Spec.prx()(Example_ExternalComponents_Spec["newtypeUserForm'"])(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "whiskey";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).whiskey)(v.value1.value0)))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.reset_(new Data_Symbol.IsSymbol(function () {
                          return "email";
                      }))(Formless_Class_Initial.initialMaybe)(Example_ExternalComponents_Spec["newtypeUserForm'"])()((Example_ExternalComponents_Spec.prx()(Example_ExternalComponents_Spec["newtypeUserForm'"])(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "email";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "language";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "whiskey";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).email)))(function (v2) {
                          return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.send(Example_ExternalComponents_Types.Email.value)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create)));
                      });
                  }));
              };
              if (v.value0 instanceof Example_ExternalComponents_Types.Language) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "whiskey";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).language)(v.value1.value0)));
              };
              throw new Error("Failed pattern match at Example.ExternalComponents.Component line 70, column 52 - line 81, column 52: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Example.ExternalComponents.Component line 51, column 10 - line 81, column 52: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: Data_Function["const"](Data_Unit.unit),
          render: render,
...
(function(exports) {
  ...
  var HandleMemberForm = (function () {
      function HandleMemberForm(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      HandleMemberForm.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleMemberForm(value0, value1, value2);
              };
          };
      };
  ...
  var HandleEventForm = (function () {
      function HandleEventForm(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleEventForm.create = function (value0) {
          return function (value1) {
              return new HandleEventForm(value0, value1);
          };
      };
      return HandleEventForm;
  })();
  var AddMemberForm = (function () {
      function AddMemberForm(value0) {
          this.value0 = value0;
      };
      AddMemberForm.create = function (value0) {
          return new AddMemberForm(value0);
      };
      return AddMemberForm;
  })();
  var RemoveMemberForm = (function () {
      function RemoveMemberForm(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      RemoveMemberForm.create = function (value0) {
          return function (value1) {
              return new RemoveMemberForm(value0, value1);
          };
      };
      return RemoveMemberForm;
  })();
  var SubmitAll = (function () {
      function SubmitAll(value0) {
          this.value0 = value0;
      };
      SubmitAll.create = function (value0) {
          return new SubmitAll(value0);
      };
      return SubmitAll;
  })();
  ...
  var renderMemberForm = function (i) {
      return function (fs) {
          return Example_App_UI_Element.formContent_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Example_App_UI_Element.buttonPrimary([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.raise(Halogen_Query.action(RemoveMemberForm.create(i))))) ])([ Halogen_HTML_Core.text("Remove Me") ]) ]), Example_App_UI_Element.input({
              label: "Member Name",
              help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Provide the registrant's name")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))(newtypeMemberForm)()(Data_Symbol.SProxy.value)(fs.form)),
              placeholder: "Dale Cooper"
          })([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(newtypeMemberForm)()(Data_Symbol.SProxy.value)(fs.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(newtypeMemberForm)()(Data_Symbol.SProxy.value))) ]), Example_App_UI_Element.input({
              label: "Member Email",
              ...
              return "notes";
          }))(newtypeMemberForm)()(Data_Symbol.SProxy.value)(fs.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.set(new Data_Symbol.IsSymbol(function () {
              return "notes";
          }))(newtypeMemberForm)()(Data_Symbol.SProxy.value))) ]) ]);
      };
  };
  ...
  var memberFormValidation = {
      name: Example_App_Validation.minLength(Effect_Aff.monadAff)(5),
      email: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(Example_App_Validation.emailFormat(Effect_Aff.monadAff))(Example_App_Validation.emailIsUsed(Effect_Aff.monadEffectAff)),
      notes: Formless_Validation.hoistFn_(Effect_Aff.monadAff)(Control_Category.identity(Control_Category.categoryFn))
  };
  var renderEventForm = function (st) {
      return function (fs) {
          var mkMemberForm = function (i) {
              return Halogen_HTML.slot(i)(Formless_Component.component(Data_Ord.ordVoid)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "notes";
              }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "notes";
              }))()(Formless_Transform_Internal.inputFieldsToFormFieldsNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
                  return "email";
              }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
                  return "notes";
              }))()(Formless_Transform_Internal.inputFieldsToInputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
                  return "email";
              }))()(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))()(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "notes";
              }))()(Formless_Transform_Internal.setFormFieldsTouchedNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
                  return "email";
              }))(Formless_Types_Form.newtypeInputField)(Formless_Types_Form.newtypeFormField)()()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))(Formless_Types_Form.newtypeInputField)(Formless_Types_Form.newtypeFormField)()()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "email";
              }))(Effect_Aff.monadAff)()(newtypeMemberForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))(Effect_Aff.monadAff)()(newtypeMemberForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
                  return "notes";
              }))(Effect_Aff.monadAff)()(newtypeMemberForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationNil(Effect_Aff.monadAff)))))(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
                  return "email";
              }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
                  return "notes";
              }))()(Formless_Transform_Internal.formFieldsToMaybeOutputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(newtypeMemberForm)(newtypeMemberForm)(newtypeMemberForm)(newtypeMemberForm)(newtypeMemberForm)(newtypeMemberForm)(newtypeMemberForm)(newtypeMemberForm))({
                  initialInputs: Formless_Transform_Record.wrapInputFields(newtypeMemberForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      return "name";
                  }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              ...
              })(Halogen_HTML_Events.input(function ($43) {
                  return Formless_Query.raise(Halogen_Query.action(HandleMemberForm.create(i)($43)));
              }));
          };
          return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field is-grouped") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Example_App_UI_Element.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.raise(Halogen_Query.action(AddMemberForm.create)))) ])([ Halogen_HTML_Core.text("Add Member Form") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Example_App_UI_Element.buttonPrimary([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.raise(Halogen_Query.action(SubmitAll.create)))) ])([ Halogen_HTML_Core.text("Submit") ]) ]) ]), Example_App_UI_Element.input({
              label: "Event Name",
              help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Provide an event name")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))(newtypeEventForm)()(Data_Symbol.SProxy.value)(fs.form)),
              placeholder: "My Event"
          })([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(newtypeEventForm)()(Data_Symbol.SProxy.value)(fs.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(newtypeEventForm)()(Data_Symbol.SProxy.value))) ]), Example_App_UI_Element.input({
              ...
              return "location";
          }))(newtypeEventForm)()(Data_Symbol.SProxy.value))) ]) ])(Data_Functor.map(Data_Functor.functorArray)(mkMemberForm)(st.formIds)));
      };
  };
  var eventFormValidation = {
      ...
      members: Example_App_Validation.exists(Effect_Aff.monadAff)
  };
  var component = (function () {
      var render = function (st) {
          return Example_App_UI_Element.section_([ Example_App_UI_Element.h1_([ Halogen_HTML_Core.text("Formless") ]), Example_App_UI_Element.h2_([ Halogen_HTML_Core.text("A form with a dynamic array of nested sub-forms.") ]), Example_App_UI_Element.p_("It is possible to nest sub-forms within Formless like any other external component. This " + ("allows you to create an arbitrary number of forms within other forms while preserving the " + ("type safety provided by the Formless library. Try submitting the form with no sub-forms, and " + ("review the output in the console. Next, try adding one or more sub-forms and submitting them " + "when valid or invalid.")))), Halogen_HTML_Elements.br_, Halogen_HTML.slot(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordInt)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "members";
              ...
              return "location";
          }))(Effect_Aff.monadAff)()(newtypeEventForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "members";
          }))(Effect_Aff.monadAff)()(newtypeEventForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(Effect_Aff.monadAff)()(newtypeEventForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationNil(Effect_Aff.monadAff)))))(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "location";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "members";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(newtypeEventForm)(newtypeEventForm)(newtypeEventForm)(newtypeEventForm)(newtypeEventForm)(newtypeEventForm)(newtypeEventForm)(newtypeEventForm))({
              initialInputs: Formless_Transform_Record.wrapInputFields(newtypeEventForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "location";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "members";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  name: "",
                  location: "",
                  members: Data_Maybe.Nothing.value
              }),
              validators: eventFormValidation,
              render: renderEventForm(st)
          })(Halogen_HTML_Events.input(HandleEventForm.create)) ]);
      };
      var $$eval = function (v) {
          if (v instanceof HandleEventForm && v.value0 instanceof Formless_Types_Component.Emit) {
          ...
          if (v instanceof HandleEventForm) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          if (v instanceof HandleMemberForm && v.value1 instanceof Formless_Types_Component.Emit) {
          ...
          if (v instanceof SubmitAll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable["for"](Halogen_Query_HalogenM.applicativeHalogenM)(Data_Traversable.traversableArray)(v1.formIds)(function (id) {
                      return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.send(id)(Formless_Query.submitReply));
                  }))(function (v2) {
                      var members = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorArray)(Formless_Transform_Record.unwrapOutputFields(newtypeMemberForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "email";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "name";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "notes";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()()))))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Control_Bind.join(Data_Maybe.bindMaybe))(v2));
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.set_(new Data_Symbol.IsSymbol(function () {
                          return "members";
                      }))(newtypeEventForm)()(Data_Symbol.SProxy.value)(members)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Formless_Query.submitReply))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var v5 = Control_Bind.join(Data_Maybe.bindMaybe)(v4);
                                  if (v5 instanceof Data_Maybe.Nothing) {
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("Forms are not valid"));
                                  };
                                  if (v5 instanceof Data_Maybe.Just) {
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                                          Effect_Console.log("Valid!")();
                                          return Effect_Console.logShow(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                              ...
                                              return "notes";
                                          }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showString))(Example_App_Validation.showEmail)))))(Data_Show.showString)))(Formless_Transform_Record.unwrapOutputFields(newtypeEventForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                                              return "location";
                                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                                              return "members";
                                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                                              return "name";
                                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()()))(v5.value0))();
                                      });
                                  };
                                  throw new Error("Failed pattern match at Example.Nested.Component line 91, column 7 - line 95, column 51: " + [ v5.constructor.name ]);
                              })())(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                              });
                          });
          ...
          if (v instanceof AddMemberForm) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $34.nextId = st.nextId + 1 | 0;
                  $34.formIds = Data_Array.snoc(st.formIds)(st.nextId);
                  return $34;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof RemoveMemberForm) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $38 = {};
                  for (var $39 in st) {
                      if ({}.hasOwnProperty.call(st, $39)) {
                  ...
                  $38.formIds = Data_Array.filter(function (v2) {
                      return v2 !== v.value0;
                  })(st.formIds);
                  return $38;
              }))(function () {
          ...
          throw new Error("Failed pattern match at Example.Nested.Component line 67, column 10 - line 105, column 13: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
  ...
  exports["RemoveMemberForm"] = RemoveMemberForm;
  exports["SubmitAll"] = SubmitAll;
  exports["component"] = component;
  exports["EventForm"] = EventForm;
  exports["eventFormValidation"] = eventFormValidation;
  exports["renderEventForm"] = renderEventForm;
  exports["MemberForm"] = MemberForm;
  exports["memberFormValidation"] = memberFormValidation;
  exports["renderMemberForm"] = renderMemberForm;
  exports["newtypeEventForm"] = newtypeEventForm;
  exports["newtypeMemberForm"] = newtypeMemberForm;
})(PS["Example.Nested.Component"] = PS["Example.Nested.Component"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
(function(exports) {
  ...
  var ordGroupTASlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Example.RealWorld.Types line 63, column 8 - line 63, column 50: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  exports["GroupForm"] = GroupForm;
  exports["OptionsForm"] = OptionsForm;
...
(function(exports) {
  ...
  var renderWhiskey = function (state) {
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Choose a whiskey to be awarded")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              return "whiskey";
          }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_RealWorld_Types.TASingle.create($0)));
      })) ]);
  };
  var renderSecretKey2 = function (st) {
      return Example_App_UI_Element.input({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Confirm the secret identifier for the group")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey2)(st.form)),
          ...
          return "whiskey";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey2)(st.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (str) {
          return Formless_Types_Component.AndThen.create(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
              return "secretKey2";
          }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey2)(str))(Formless_Query.validate_(new Data_Symbol.IsSymbol(function () {
              return "secretKey1";
          }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey1));
      })) ]);
  };
  var renderSecretKey1 = function (st) {
      return Example_App_UI_Element.input({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Provide a secret identifier for the group")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey1)(st.form)),
          placeholder: "ia30<>Psncdi3b#$<0423"
      })([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          return "secretKey1";
      }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "whiskey";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey1)(st.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (str) {
          return Formless_Types_Component.AndThen.create(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
              return "secretKey1";
          }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey1)(str))(Formless_Query.validate_(new Data_Symbol.IsSymbol(function () {
              return "secretKey2";
          }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey2));
      })) ]);
  };
  var renderPixels = function (state) {
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Choose a pixel to track")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).pixels)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_RealWorld_Types.TAMulti.create(Example_RealWorld_Types.Pixels.value)($1)));
      })) ]);
  };
  var renderName = Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
      ...
      sym: (Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "admin";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "applications";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
  ...
  var renderApplications = function (state) {
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Applications are available in several sizes")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).applications)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_RealWorld_Types.TAMulti.create(Example_RealWorld_Types.Applications.value)($2)));
      })) ]);
  };
  var renderAdmin = function (state) {
      ...
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Choose an administrator for the account")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).admin)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_RealWorld_Types.AdminDropdown.create($3)));
      })) ]);
  };
...
(function(exports) {
  ...
  var renderViewCost = Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
      ...
      sym: (Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "dimensions";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).viewCost
  });
  var renderSpeed = function (state) {
      var speed = Data_Lens_Getter.view(Formless_Retrieve._Field(new Data_Symbol.IsSymbol(function () {
          return "speed";
      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "dimensions";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
      ...
      return Example_App_UI_Element.field({
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).speed)(Example_RealWorld_Data_Options.Low.value))) ]), Halogen_HTML_Core.text(" " + Data_Show.show(Example_RealWorld_Data_Options.showSpeed)(Example_RealWorld_Data_Options.Low.value)) ]), Halogen_HTML_Elements.label([ Example_App_UI_Element.css("radio") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.name("speed"), Example_App_UI_Element.css("radio"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.checked(Data_Eq.eq(Example_RealWorld_Data_Options.eqSpeed)(speed.input)(Example_RealWorld_Data_Options.Medium.value)), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.set(new Data_Symbol.IsSymbol(function () {
          return "speed";
      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).speed)(Example_RealWorld_Data_Options.Medium.value))) ]), Halogen_HTML_Core.text(" " + Data_Show.show(Example_RealWorld_Data_Options.showSpeed)(Example_RealWorld_Data_Options.Medium.value)) ]), Halogen_HTML_Elements.label([ Example_App_UI_Element.css("radio") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.name("speed"), Example_App_UI_Element.css("radio"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.checked(Data_Eq.eq(Example_RealWorld_Data_Options.eqSpeed)(speed.input)(Example_RealWorld_Data_Options.Fast.value)), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Query.set(new Data_Symbol.IsSymbol(function () {
          return "speed";
      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).speed)(Example_RealWorld_Data_Options.Fast.value))) ]), Halogen_HTML_Core.text(" " + Data_Show.show(Example_RealWorld_Data_Options.showSpeed)(Example_RealWorld_Data_Options.Fast.value)) ]) ]);
  };
  var renderSize = Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
      ...
      sym: (Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).size
  });
  var renderMetric = function (state) {
      return Example_App_UI_Element.field({
          ...
          help: Example_App_UI_Element.resultToHelp(Example_App_Validation.toTextFieldError)("Choose a metric to optimize for.")(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
              ...
              return "viewCost";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).metric)(state.form))
          ...
          return Formless_Types_Component.Raise.create(Halogen_Query.action(Example_RealWorld_Types.MetricDropdown.create($6)));
      })) ]);
  };
  var renderInstallCost = Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
      ...
      sym: (Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).installCost
  });
  var renderEnabled = function (state) {
      return Example_App_UI_Element.field({
          label: "Enable",
          help: new Data_Either.Right("Do you want to enable this set of options?")
      })([ Halogen_HTML_Elements.label([ Example_App_UI_Element.css("checkbox") ])([ Halogen_HTML_Elements.input([ Example_App_UI_Element.css("checkbox"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          return "enable";
      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).enable)(state.form)), Halogen_HTML_Events.onChange(Halogen_HTML_Events.input_(Formless_Query.modify(new Data_Symbol.IsSymbol(function () {
          return "enable";
      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).enable)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)))) ]), Halogen_HTML_Core.text(" Enable extra options") ]) ]);
  };
  var renderDimensions = Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
      ...
      sym: (Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).dimensions
  });
  ...
  var renderClickCost = Example_App_UI_Element.formlessField(new Data_Symbol.IsSymbol(function () {
      ...
      sym: (Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "viewCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).clickCost
  });
  var renderMetrics = function (state) {
      var renderMetricField = function (v) {
          ...
          throw new Error("Failed pattern match at Example.RealWorld.Render.OptionsForm line 47, column 25 - line 51, column 28: " + [ v.constructor.name ]);
      };
      return [ renderMetric(state), renderMetricField(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          return "metric";
      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "clickCost";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
  ...
  var render = function (state) {
      return Example_App_UI_Element.formContent_([ renderEnabled(state), Halogen_HTML_Elements.div([ (function () {
          var $5 = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "enable";
          }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "clickCost";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "viewCost";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).enable)(state.form);
          if ($5) {
...
(function(exports) {
  ...
  var groupValidators = function (dictMonad) {
      var equalsSK2 = Formless_Validation.hoistFnE(dictMonad)(function (form) {
          return function (str1) {
              var str0 = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "secretKey2";
              }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  return "admin";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "whiskey";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey2)(form);
              var $3 = str0 === str1;
              if ($3) {
      ...
      var equalsSK1 = Formless_Validation.hoistFnE(dictMonad)(function (form) {
          return function (str1) {
              var str0 = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "whiskey";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey1)(form);
              var $4 = str0 === str1;
              if ($4) {
                  return new Data_Either.Right(str1);
              };
  ...
  var groupInputs = Formless_Transform_Row.mkInputFields()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "admin";
  }))(Formless_Class_Initial.initialMaybe)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "applications";
      ...
      return "whiskey";
  }))(Formless_Class_Initial.initialMaybe)()(Formless_Transform_Row.mkInputFieldsFromRowNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Types_Form.FormProxy.value);
      ...
      return function (form) {
          return Control_Bind.bind(dictMonad.Bind1())(Control_Applicative.pure(dictMonad.Applicative0())(10))(function (v) {
              return Control_Applicative.pure(dictMonad.Applicative0())(Example_RealWorld_Data_Group.Group(Record["delete"](new Data_Symbol.IsSymbol(function () {
                  ...
                  return "options";
              }))()()(Data_Symbol.SProxy.value)(Data_Maybe.Nothing.value)(Formless_Transform_Record.unwrapRecord(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "admin";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "applications";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "whiskey";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()())()())()())()())()()))(Data_Newtype.unwrap(Example_RealWorld_Data_Group.newtypeGroupForm)(form))))))));
          });
      };
  };
...
(function(exports) {
  ...
  var optionsFormValidators = function (dictMonad) {
      var validateMetric = function (metric) {
          return function (form) {
              return function (i) {
                  var $2 = Data_Eq.eq(Data_Maybe.eqMaybe(Example_RealWorld_Data_Options.eqMetric))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                      return "metric";
                  }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "clickCost";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "viewCost";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).metric)(form))(new Data_Maybe.Just(metric));
                  if ($2) {
  ...
  var optionsFormInputs = Formless_Transform_Row.mkInputFields()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "clickCost";
  }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "dimensions";
  }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      ...
      return "speed";
  }))(Example_RealWorld_Data_Options.initialSpeed)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
      return "viewCost";
  }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Types_Form.FormProxy.value);
  var defaultInputs = (function () {
      ...
      return Example_RealWorld_Data_Options.OptionsForm({
          ...
          metric: Formless_Types_Form.InputField(new Data_Maybe.Just(Example_RealWorld_Data_Options.ViewCost.value)),
          viewCost: "1",
  ...
  var component = (function () {
      var render = function (st) {
          return Example_App_UI_Element.section_([ Example_App_UI_Element.h1_([ Halogen_HTML_Core.text("Formless") ]), Example_App_UI_Element.h2_([ Halogen_HTML_Core.text("A complex form inspired by real-world use cases.") ]), Example_App_UI_Element.p_("This component demonstrates building a large form with complex rendering and validation " + ("requirements. Notice how both tabs end up unifying to a single output type after the " + ("two forms are combined, how various dropdowns determine the contents (and visibility) " + ("of other form elements, the assorted external components, and how validation for many " + "fields depends on the values of other fields in the form.")))), Halogen_HTML_Elements.br_, Example_App_UI_Element.p_("Next, review the source code. You'll notice that all of the complex types and state necessary " + ("to run this form can be generated from a pair of row types. All that's left for you to handle " + "is to write the validation (with helper functions) and the render function.")), Halogen_HTML_Elements.br_, Example_App_UI_Element.grouped_([ Example_App_UI_Element.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Example_RealWorld_Types.Select.create(Example_RealWorld_Types.GroupTab.value))) ])([ Example_App_UI_Element.p_("Group Form" + (function () {
              ...
              var $24 = st.groupFormDirty || st.optionsFormDirty;
              if ($24) {
              ...
              var $25 = Data_Eq.eq(Example_RealWorld_Types.eqTab)(st.focus)(Example_RealWorld_Types.GroupTab.value);
              if ($25) {
                  return Example_App_UI_Element.css("");
              };
              return Example_App_UI_Element.css("is-hidden");
          })() ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Component.component(Data_Either.ordEither(Example_RealWorld_Types.ordGroupTASlot)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid))))(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "whiskey";
          }))(Formless_Types_Form.eqInputField(Data_Maybe.eqMaybe(Data_Eq.eqString))))()(new Data_Symbol.IsSymbol(function () {
              return "secretKey2";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "admin";
          }))(Formless_Types_Form.eqInputField(Data_Maybe.eqMaybe(Example_RealWorld_Data_Group.eqAdmin))))(Formless_Transform_Internal.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))()(Formless_Transform_Internal.inputFieldsToInputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))()(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))()(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))()(Formless_Transform_Internal.setFormFieldsTouchedNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))(Formless_Types_Form.newtypeInputField)(Formless_Types_Form.newtypeFormField)()()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))(Formless_Types_Form.newtypeInputField)(Formless_Types_Form.newtypeFormField)()()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "admin";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Group.newtypeGroupForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Group.newtypeGroupForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Group.newtypeGroupForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Group.newtypeGroupForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationNil(Effect_Aff.monadAff)))))))))(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "admin";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "applications";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "whiskey";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm)(Example_RealWorld_Data_Group.newtypeGroupForm))({
              initialInputs: Example_RealWorld_Spec_GroupForm.groupInputs,
              ...
              var $26 = Data_Eq.eq(Example_RealWorld_Types.eqTab)(st.focus)(Example_RealWorld_Types.OptionsTab.value);
              if ($26) {
                  return Example_App_UI_Element.css("");
              };
              return Example_App_UI_Element.css("is-hidden");
          })() ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordUnit)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "viewCost";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "speed";
          }))(Formless_Types_Form.eqInputField(Example_RealWorld_Data_Options.eqSpeed)))()(new Data_Symbol.IsSymbol(function () {
              return "size";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "metric";
          }))(Formless_Types_Form.eqInputField(Data_Maybe.eqMaybe(Example_RealWorld_Data_Options.eqMetric))))()(new Data_Symbol.IsSymbol(function () {
              return "installCost";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "enable";
              ...
              return "viewCost";
          }))()(Formless_Transform_Internal.inputFieldsToFormFieldsNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              return "clickCost";
          }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              return "dimensions";
          }))()(Formless_Transform_Internal.inputFieldsToInputCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "viewCost";
          }))()(Formless_Transform_Internal.inputFieldsToInputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              return "clickCost";
          }))()(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              return "dimensions";
          }))()(Formless_Transform_Internal.consCountErrors(new Data_Symbol.IsSymbol(function () {
              ...
              return "viewCost";
          }))()(Formless_Transform_Internal.setFormFieldsTouchedNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              return "clickCost";
          }))(Formless_Types_Form.newtypeInputField)(Formless_Types_Form.newtypeFormField)()()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              return "dimensions";
          }))(Formless_Types_Form.newtypeInputField)(Formless_Types_Form.newtypeFormField)()()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.replaceFormFieldInputsTouchedCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "clickCost";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Options.newtypeOptionsForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "dimensions";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Options.newtypeOptionsForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "enable";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Options.newtypeOptionsForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "viewCost";
          }))(Effect_Aff.monadAff)()(Example_RealWorld_Data_Options.newtypeOptionsForm)()(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Internal.applyToValidationNil(Effect_Aff.monadAff))))))))))(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "clickCost";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "dimensions";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "viewCost";
          }))()(Formless_Transform_Internal.formFieldsToMaybeOutputNil)(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Formless_Transform_Internal.row1Cons()()))(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm)(Example_RealWorld_Data_Options.newtypeOptionsForm))({
              initialInputs: Example_RealWorld_Spec_OptionsForm.defaultInputs,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Example_RealWorld_Types.Reset) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query["send'"](Halogen_Component_ChildPath.cp1)(Example_RealWorld_Types.Applications.value)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create))))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query["send'"](Halogen_Component_ChildPath.cp1)(Example_RealWorld_Types.Pixels.value)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create))))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query["send'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Halogen_Query.action(Example_App_UI_Typeahead.Clear.create))))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query["send'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Halogen_Query.action(Example_App_UI_Dropdown.Clear.create))))(function (v4) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Query.send(Data_Unit.unit)(Halogen_Query.action(Example_App_UI_Dropdown.Clear.create))))(function (v5) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.resetAll_))(function (v6) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Query.resetAll_))(function (v7) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                                      });
                                  });
                              });
          ...
          if (v instanceof Example_RealWorld_Types.Submit) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.request(Formless_Types_Component.SubmitReply.create)))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Halogen_Query.request(Formless_Types_Component.SubmitReply.create)))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Halogen_Query_HalogenM.applicativeHalogenM)(Example_RealWorld_Spec_GroupForm.groupFormSubmit(Halogen_Query_HalogenM.monadHalogenM))(v1.value0))(function (v3) {
                                  var options = Data_Functor.map(Data_Maybe.functorMaybe)(function ($83) {
                                      return Example_RealWorld_Data_Options.Options(Formless_Transform_Record.unwrapOutputFields(Example_RealWorld_Data_Options.newtypeOptionsForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                                          return "clickCost";
                                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                                          return "dimensions";
                                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                                          ...
                                          return "viewCost";
                                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()())()())()())()())()())()()))($83));
                                  })(v2.value0);
          ...
          if (v instanceof Example_RealWorld_Types.GroupForm) {
              ...
              throw new Error("Failed pattern match at Example.RealWorld.Component line 151, column 22 - line 156, column 15: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Example_RealWorld_Types.TASingle) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                  return "whiskey";
              }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  return "admin";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "whiskey";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).whiskey)(v.value0.value0)));
          };
          if (v instanceof Example_RealWorld_Types.TAMulti) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value2)((function () {
                  if (v.value0 instanceof Example_RealWorld_Types.Applications) {
                      return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                          return "applications";
                      }))(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "admin";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "whiskey";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).applications)(v.value1.value0));
                  };
                  if (v.value0 instanceof Example_RealWorld_Types.Pixels) {
                      return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "whiskey";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).pixels)(v.value1.value0));
                  };
                  throw new Error("Failed pattern match at Example.RealWorld.Component line 161, column 55 - line 165, column 63: " + [ v.value0.constructor.name ]);
              })());
          };
          if (v instanceof Example_RealWorld_Types.AdminDropdown) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.reset_(new Data_Symbol.IsSymbol(function () {
                  return "secretKey1";
              }))(Formless_Class_Initial.initialString)(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  return "admin";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  return "applications";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "whiskey";
              }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey1)))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.reset_(new Data_Symbol.IsSymbol(function () {
                      return "secretKey2";
                  }))(Formless_Class_Initial.initialString)(Example_RealWorld_Data_Group.newtypeGroupForm)()((Example_RealWorld_Data_Group.prx()(Example_RealWorld_Data_Group.newtypeGroupForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "admin";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "whiskey";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).secretKey2)))(function (v2) {
                      if (v.value0 instanceof Example_App_UI_Dropdown.Selected) {
                          return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                              ...
                              return "whiskey";
                          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).admin)(new Data_Maybe.Just(v.value0.value0)));
                      };
                      if (v.value0 instanceof Example_App_UI_Dropdown.Cleared) {
                          return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                              ...
                              return "whiskey";
                          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))))))).admin)(Data_Maybe.Nothing.value));
                      };
                      throw new Error("Failed pattern match at Example.RealWorld.Component line 170, column 7 - line 174, column 68: " + [ v.value0.constructor.name ]);
                  });
              }));
          };
          if (v instanceof Example_RealWorld_Types.OptionsForm) {
              ...
              if (v.value0 instanceof Formless_Types_Component.Changed) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $71.optionsEnabled = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                              return "enable";
                          }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                              return "clickCost";
                          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                              ...
                              return "viewCost";
                          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).enable)(v.value0.value0.form);
                          return $71;
                      }))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1.optionsEnabled !== v2.optionsEnabled)((function () {
                              if (v2.optionsEnabled) {
                                  ...
                                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Query.initialize_(spec$prime)));
                              };
                              return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Query.initialize_(Example_RealWorld_Spec_OptionsForm.defaultInputs)));
                          })()))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
              ...
              throw new Error("Failed pattern match at Example.RealWorld.Component line 179, column 24 - line 199, column 15: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Example_RealWorld_Types.MetricDropdown) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                  if (v.value0 instanceof Example_App_UI_Dropdown.Selected) {
                      return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                          return "metric";
                      }))(Example_RealWorld_Data_Options.newtypeOptionsForm)()((Example_RealWorld_Data_Options.prx()(Example_RealWorld_Data_Options.newtypeOptionsForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "clickCost";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "viewCost";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).metric)(new Data_Maybe.Just(v.value0.value0)));
                  };
                  if (v.value0 instanceof Example_App_UI_Dropdown.Cleared) {
                      return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
                          return "metric";
                          ...
                          return "viewCost";
                      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))))))).metric)(Data_Maybe.Nothing.value));
                  };
                  throw new Error("Failed pattern match at Example.RealWorld.Component line 201, column 32 - line 205, column 60: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at Example.RealWorld.Component line 111, column 10 - line 205, column 60: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var Example_Nested_Component = PS["Example.Nested.Component"];
