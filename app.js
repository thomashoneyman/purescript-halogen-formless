...
(function($PS) {
  ...
  var ordTypeahead = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Example.ExternalComponents.Form (line 57, column 1 - line 57, column 46): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var component = (function () {
      var prx = Formless_Transform_Row.mkSProxies()()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
      ...
      var handleEvent = function (v) {
          ...
          throw new Error("Failed pattern match at Example.ExternalComponents.Form (line 79, column 17 - line 81, column 74): " + [ v.constructor.name ]);
      };
      var handleAction = (function () {
          ...
          return function (v) {
              if (v instanceof HandleTypeahead) {
                  ...
                  throw new Error("Failed pattern match at Example.ExternalComponents.Form (line 86, column 56 - line 96, column 46): " + [ v.value0.constructor.name ]);
              };
              ...
              throw new Error("Failed pattern match at Example.ExternalComponents.Form (line 85, column 18 - line 102, column 22): " + [ v.constructor.name ]);
          };
      })();
      var defaultInput = {
          validators: {
  ...
  var eventComponent = (function () {
      ...
      var handleAction = (function () {
          ...
          return function (v) {
              ...
              throw new Error("Failed pattern match at Example.Nested.Form (line 79, column 18 - line 93, column 73): " + [ v.constructor.name ]);
          };
      })();
      var eventFormInput = {
          validators: {
  ...
  var component = (function () {
      var render = function (v) {
          ...
          return Example_App_UI_Element.formContent_([ renderEnabled, Halogen_HTML_Elements.div([ Example_App_UI_Element.class_(Data_Monoid.guard(Data_Monoid.monoidString)(!Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              ...
              throw new Error("Failed pattern match at Example.RealWorld.OptionsForm (line 192, column 11 - line 196, column 34): " + [ v1.constructor.name ]);
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Example.RealWorld.OptionsForm (line 183, column 27 - line 185, column 60): " + [ v.value0.constructor.name ]);
      };
      var $$eval = function (act) {
...
(function($PS) {
  ...
  var ordTASlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Example.RealWorld.GroupForm (line 117, column 1 - line 117, column 40): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
      ...
      var handleAction = (function () {
          ...
          return function (v) {
              ...
              if (v instanceof HandleDropdown) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.reset(new Data_Symbol.IsSymbol(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.reset(new Data_Symbol.IsSymbol(function () {
                          ...
                          throw new Error("Failed pattern match at Example.RealWorld.GroupForm (line 212, column 7 - line 216, column 49): " + [ v.value0.constructor.name ]);
                      });
                  });
              };
              ...
              if (v instanceof HandleTAMulti) {
                  ...
                  throw new Error("Failed pattern match at Example.RealWorld.GroupForm (line 221, column 54 - line 223, column 52): " + [ v.value0.constructor.name ]);
              };
              throw new Error("Failed pattern match at Example.RealWorld.GroupForm (line 179, column 18 - line 223, column 52): " + [ v.constructor.name ]);
          };
      })();
