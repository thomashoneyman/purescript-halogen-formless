...
(function($PS) {
  ...
  var Record_Unsafe = $PS["Record.Unsafe"];
  var Unsafe_Coerce = $PS["Unsafe.Coerce"];
  var traverseSome = function (dictRowToList) {
  ...
  var traverse = function (dictRowToList) {
      return function (dictVariantTravCases) {
          return function (dictUnion) {
              return function (dictUnion1) {
                  return function (dictApplicative) {
                      return function (r) {
                          return traverseSome()()()()((dictApplicative.Apply0()).Functor0())(r)((function () {
                              var $117 = Control_Applicative.pure(dictApplicative);
                              return function ($118) {
                                  return $117($118);
                              };
                          })());
  ...
  var overSome = function (dictRowToList) {
  ...
  var over = function (dictRowToList) {
      return function (dictVariantMapCases) {
          return function (dictUnion) {
              return function (dictUnion1) {
                  return function (r) {
...
(function($PS) {
  ...
  var mkFieldResults1 = function (dictHFoldlWithIndex) {
      return {
          mkFieldResults: (function () {
              var $208 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Function.flip(Record_Builder.build)({}));
              var $209 = Heterogeneous_Folding.hfoldlWithIndex(dictHFoldlWithIndex)(MkFieldResult.value)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Control_Category.identity(Record_Builder.categoryBuilder)));
              return function ($210) {
                  return $208($209($210));
              };
          })(),
  ...
  var mkFieldOutputs1 = function (dictHFoldlWithIndex) {
      return {
          mkFieldOutputs: (function () {
              var $211 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Function.flip(Record_Builder.build)({}));
              var $212 = Heterogeneous_Folding.hfoldlWithIndex(dictHFoldlWithIndex)(MkFieldOutput.value)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Control_Category.identity(Record_Builder.categoryBuilder)));
              return function ($213) {
                  return $211($212($213));
              };
          })(),
                      ...
                      return function (sym) {
                          return function (v1) {
                              ...
                              return {
                                  ...
                                  modify: (function () {
                                      var $214 = ModifyField.create(fieldVariant);
                                      return function ($215) {
                                          return v($214($215));
                                      };
                                  })(),
                                  ...
                                  handleChange: (function () {
                                      var $216 = ChangeField.create(fieldVariant);
                                      return function ($217) {
                                          return v($216($217));
                                      };
                                  })(),
                                  handleBlur: (function () {
                                      var $218 = BlurField.create(fieldVariant);
                                      return function ($219) {
                                          return v($218($219));
                                      };
                                  })()
  ...
  var validateM = function (dictRowToList) {
      return function (dictVariantTravCases) {
          return function (dictUnion) {
              return function (dictUnion1) {
                  return function (dictApplicative) {
  ...
  var validate = function (dictRowToList) {
      return function (dictVariantMapCases) {
          return function (dictUnion) {
              return function (dictUnion1) {
  ...
  var raise = function ($220) {
      return Halogen_Query_HalogenM.raise(Raise.create($220));
  };
              ...
              return function (v) {
                  ...
                  if (v instanceof Validate) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(validateM$prime(v.value0)(validators))(function (validated) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.Just.create(v.value1(validated)));
                      });
                  };
      ...
      return function (validate$prime) {
          return function (validators) {
              return function (v) {
                  ...
                  if (v instanceof Validate) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.Just.create(v.value1(validate$prime(v.value0)(validators))));
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.Nothing.value);
              };
          };
                                  ...
                                  return function (component) {
                                      ...
                                      var initialState = function (input) {
                                          ...
                                          var initialFormActions = {
                                              setFields: function ($221) {
                                                  return initialFullConfig.liftAction(SetForm.create($221));
                                              },
                                              reset: initialFullConfig.liftAction(ResetForm.value),
                                              setConfig: function ($222) {
                                                  return initialFullConfig.liftAction(SetFormConfig.create($222));
                                              },
                                              submit: initialFullConfig.liftAction(new SubmitForm(Data_Maybe.Nothing.value)),
                                              handleSubmit: function ($223) {
                                                  return initialFullConfig.liftAction(SubmitForm.create(Data_Maybe.Just.create($223)));
                                              }
                                          };
                                      ...
                                      var getKeys = (function () {
                                          var $224 = Safe_Coerce.coerce();
                                          return function ($225) {
                                              return $224(Foreign_Object.keys($225));
                                          };
                                      })();
                                      ...
                                      var fieldsKey = function ($226) {
                                          return Safe_Coerce.coerce()($226.type);
                                      };
                                      ...
                                      var runValidation = function (fieldKey) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                              var $227 = Halogen_Query.request()({
                                                  reflectSymbol: function () {
                                                      return "inner";
                                                  }
                                              })(Data_Ord.ordUnit)(Type_Proxy["Proxy"].value)(Data_Unit.unit);
                                              var $228 = getField(fieldKey);
                                              return function ($229) {
                                                  return $227(Validate.create($228($229)));
                                              };
                                              ...
                                              return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(mbResult)(function (resultVariant) {
                                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                      ...
                                                      $140.fieldObject = fieldObject;
                                                      $140.formState = (function () {
                                                          var $137 = {};
                                                          for (var $138 in state.formState) {
                                                              if ({}.hasOwnProperty.call(state.formState, $138)) {
                                                                  $137[$138] = state["formState"][$138];
                                                              };
                                                          };
                                                          $137.errorCount = countErrors(fieldObject);
                                                          $137.allTouched = allTouched(fieldObject);
                                                          return $137;
                                                      })();
                                                      return $140;
                                                  });
                                      ...
                                      var runFormAction = function (action) {
                                          return handleAction(HandleForm.create(new Eval(action)));
                                      };
                                      var handleAction = function (v) {
                                          ...
                                          if (v instanceof HandleForm && v.value0 instanceof Eval) {
                                                          ...
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                                  ...
                                                                  for (var $163 in state) {
                                                                      if ({}.hasOwnProperty.call(state, $163)) {
                                                                          $162[$163] = state[$163];
                                                                      };
                                                                  };
                                                                  $162.formState = (function () {
                                                                      var $159 = {};
                                                                      for (var $160 in state.formState) {
                                                                          if ({}.hasOwnProperty.call(state.formState, $160)) {
                                                                              $159[$160] = state["formState"][$160];
                                                                          };
                                                                      };
                                                                      $159.submitCount = state.formState.submitCount + 1 | 0;
                                                                      return $159;
                                                                  })();
                                                                  return $162;
                                                              }))(function () {
                                                                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(mkFieldResults(dictMkFieldResults)(v1.fieldObject))(function (results) {
                                                                      ...
                                                                      throw new Error("Failed pattern match at Formless (line 366, column 75 - line 368, column 64): " + [ v2.constructor.name ]);
                                                                  });
                                                              });
                                                          });
                                                      });
                                              ...
                                              if (v.value0.value0 instanceof SetForm) {
                                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                      ...
                                                      for (var $170 in state) {
                                                          if ({}.hasOwnProperty.call(state, $170)) {
                                                              $169[$170] = state[$170];
                                                          };
                                                      };
                                                      $169.fieldObject = v.value0.value0.value0;
                                                      return $169;
                                                  });
                                              };
                                              if (v.value0.value0 instanceof SetFormConfig) {
                                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                      var $173 = {};
                                                      for (var $174 in state) {
                                                          if ({}.hasOwnProperty.call(state, $174)) {
                                                              $173[$174] = state[$174];
                                                          };
                                                      };
                                                      $173.formConfig = v.value0.value0.value0;
                                                      return $173;
                                                  });
                                              };
                                              if (v.value0.value0 instanceof ResetForm) {
                                                  var reset = function (field) {
                                                      var $177 = {};
                                                      for (var $178 in field) {
                                                          if ({}.hasOwnProperty.call(field, $178)) {
                                                              $177[$178] = field[$178];
                                                          };
                                                      };
                                                      $177.value = field.initialValue;
                                                      $177.result = Data_Maybe.Nothing.value;
                                                      return $177;
                                                  };
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                      var $180 = {};
                                                      ...
                                                      $180.fieldObject = Data_Functor.map(Foreign_Object.functorObject)(reset)(state.fieldObject);
                                                      $180.formState = {
                                                          submitCount: 0,
                                                          errorCount: 0,
                                                          allTouched: false
                                              ...
                                              if (v.value0.value0 instanceof ChangeField) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                      ...
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                          var $184 = {};
                                                          for (var $185 in state) {
                                                              if ({}.hasOwnProperty.call(state, $185)) {
                                                                  $184[$185] = state[$185];
                                                              };
                                                          };
                                                          $184.fieldObject = modifyField(modify)(state.fieldObject);
                                                          return $184;
                                                      }))(function () {
                                              ...
                                              if (v.value0.value0 instanceof ModifyField) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                      ...
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                          ...
                                                          $195.fieldObject = modifyField(modify)(state.fieldObject);
                                                          return $195;
                                                      }))(function () {
                                              ...
                                              if (v.value0.value0 instanceof ResetField) {
                                                  ...
                                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                      var $202 = {};
                                                      for (var $203 in state) {
                                                          if ({}.hasOwnProperty.call(state, $203)) {
                                                              $202[$203] = state[$203];
                                                          };
                                                      };
                                                      $202.fieldObject = modifyField(modify)(state.fieldObject);
                                                      return $202;
                                                  });
                                              };
                                              throw new Error("Failed pattern match at Formless (line 358, column 33 - line 410, column 89): " + [ v.value0.value0.constructor.name ]);
                                          };
                                          throw new Error("Failed pattern match at Formless (line 344, column 18 - line 410, column 89): " + [ v.constructor.name ]);
                                      };
                                      return Halogen_Component.mkComponent({
                                          ...
                                          "eval": Halogen_Component.mkEval({
                                              ...
                                              receive: function ($230) {
                                                  return Data_Maybe.Just.create(Receive.create($230));
                                              },
                                              finalize: Data_Maybe.Nothing.value,
                                              handleAction: handleAction,
                                              handleQuery: (function () {
                                                  var $231 = Halogen_Query_HalogenM.query()({
                                                      reflectSymbol: function () {
                                                          return "inner";
                                                      }
                                                  })(Data_Ord.ordUnit)(Type_Proxy["Proxy"].value)(Data_Unit.unit);
                                                  return function ($232) {
                                                      return $231(Query.create($232));
                                                  };
                                              })()
                                          })
                                      });
  ...
  var $$eval = function ($233) {
      return Halogen_Query_HalogenM.raise(Eval.create($233));
  };
  var defaultConfig = {
      validateOnBlur: true,
  ...
  var longerThan = function (limit) {
      return function (str) {
          if (Data_String_CodePoints.length(str) <= limit) {
              return Data_Either.Left.create("Must be longer than " + (Data_Show.show(Data_Show.showInt)(limit) + " characters."));
          };
          if (Data_Boolean.otherwise) {
...
(function($PS) {
  ...
  var stories = (function () {
      var localStorage = (function () {
          ...
          return Data_Tuple.Tuple.create("5. " + "Local Storage")(Halogen_Storybook_Proxy.proxy(component));
      })();
      var home = (function () {
          ...
          return Data_Tuple.Tuple.create("")(Halogen_Storybook_Proxy.proxy(component));
      })();
      var fileUpload = (function () {
          ...
          return Data_Tuple.Tuple.create("3. " + "File Upload")(Halogen_Storybook_Proxy.proxy(component));
      })();
      var dependentFields = (function () {
          ...
          return Data_Tuple.Tuple.create("4. " + "Dependent Fields")(Halogen_Storybook_Proxy.proxy(component));
      })();
      var checkboxRadio = (function () {
          ...
          return Data_Tuple.Tuple.create("2. " + "Checkbox & Radio")(Halogen_Storybook_Proxy.proxy(component));
      })();
      var basic = (function () {
          var component = mkExample(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
              reflectSymbol: function () {
          ...
          return Data_Tuple.Tuple.create("1. " + "Basic")(Halogen_Storybook_Proxy.proxy(component));
      })();
